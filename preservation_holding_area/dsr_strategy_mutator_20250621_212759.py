...
class DsrStrategyMutatorEventBusIntegration:
    ...
    """EventBus integration for dsr_strategy_mutator"""
    
    def __init__(self):
        self.module_id = "dsr_strategy_mutator"
        self.event_routes = []
...
dsr_strategy_mutator_eventbus = DsrStrategyMutatorEventBusIntegration()
