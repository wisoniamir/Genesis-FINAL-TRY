    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in traceback: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("traceback", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in traceback: {e}")
...
class Frame:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in traceback: {e}")
    filename: str
    lineno: int
    name: str
    line: str = ""
