    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in search: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("search", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in search: {e}")
...
class TransformedHit(TypedDict):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in search: {e}")
    name: str
    summary: str
    versions: List[str]
