...
class LiveBacktestComparisonEngineEventBusIntegration:
    ...
    """EventBus integration for live_backtest_comparison_engine"""
    
    def __init__(self):
        self.module_id = "live_backtest_comparison_engine"
        self.event_routes = []
...
live_backtest_comparison_engine_eventbus = LiveBacktestComparisonEngineEventBusIntegration()
