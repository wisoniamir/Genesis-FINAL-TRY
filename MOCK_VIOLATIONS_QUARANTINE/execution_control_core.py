...
try:
    ...
    class TelemetryManager:
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("execution_control_core", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in execution_control_core: {e}")
...
class ControlDecisionType(Enum):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in execution_control_core: {e}")
