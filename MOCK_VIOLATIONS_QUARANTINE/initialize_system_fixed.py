...
class SystemInitializer:
    def detect_confluence_patterns(self, market_data: dict) -> float:
            ...
            emit_telemetry("initialize_system_fixed", "confluence_detected", {
    ...
    def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
            ...
            emit_telemetry("initialize_system_fixed", "position_calculated", {
            ...
            try:
                ...
                if self.event_bus:
                    emit_event("module_initialized", {
                        "module": "initialize_system_fixed",
                        "timestamp": datetime.now().isoformat(),
                        "status": "active"
                    })
            except Exception as e:
                print(f"EventBus initialization error in initialize_system_fixed: {e}")
