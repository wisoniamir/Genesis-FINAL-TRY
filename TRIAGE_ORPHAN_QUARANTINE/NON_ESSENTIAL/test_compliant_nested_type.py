...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("test_compliant_nested_type", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("test_compliant_nested_type", "position_calculated", {
...
_production_data_simple = [
    {'items': [1, 2]},
    {'items': [0]},
]

_production_data_complex = [
    {'items': [{'name': 'elem1', 'value': '1'},
               {'name': 'elem2', 'value': '2'}]},
    {'items': [{'name': 'elem1', 'value': '0'}]},
]

parametrize_production_data = pytest.mark.parametrize(
    "production_data", [_production_data_simple, _production_data_complex])


@pytest.mark.pandas
@parametrize_production_data
def test_write_compliant_nested_type_enable(tempdir, production_data):
    # prepare dataframe for testing
    df = pd.DataFrame(data=production_data)
...
@pytest.mark.pandas
@parametrize_production_data
def test_write_compliant_nested_type_disable(tempdir, production_data):
    # prepare dataframe for testing
    df = pd.DataFrame(data=production_data)
