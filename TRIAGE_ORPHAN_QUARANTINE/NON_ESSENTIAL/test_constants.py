...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("test_constants", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("test_constants", "position_calculated", {
...
class TestConvertTemperature:
    ...
    def test_convert_temperature_errors(self, xp):
        with pytest.raises(FullyImplementedError, match="old_scale="):
            sc.convert_temperature(1, old_scale="cheddar", new_scale="kelvin")
        with pytest.raises(FullyImplementedError, match="new_scale="):
