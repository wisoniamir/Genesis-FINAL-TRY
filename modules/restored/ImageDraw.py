...
# <!-- @GENESIS_MODULE_START: ImageDraw -->
"""
🏛️ GENESIS IMAGEDRAW - INSTITUTIONAL GRADE v8.0.0
===============================================================
...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("ImageDraw", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("ImageDraw", "position_calculated", {
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in ImageDraw: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("ImageDraw", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in ImageDraw: {e}")
...
class ImageDraw:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in ImageDraw: {e}")
    font: (
    ...
    def __init__(self, im: Image.Image, mode: str | None = None) -> None:
        ...
        if mode in ("I", "F"):
            ...
            self.ink = self.draw.draw_ink(-1)
        if mode in ("1", "P", "I", "F"):
            # FIXED: fix Fill2 to properly support matte for I+F images
            self.fontmode = "1"
        else:
    ...
    def getfont(
        ...
        if not self.font:
            # FIXED: should add a font repository
