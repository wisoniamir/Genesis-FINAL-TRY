    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in probe: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("probe", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in probe: {e}")
...
class _HTTP2ProbeCache:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in probe: {e}")
    __slots__ = (
        "_lock",
        "_cache_locks",
        "_cache_values",
