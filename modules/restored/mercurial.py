    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in mercurial: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("mercurial", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in mercurial: {e}")
...
class Mercurial(VersionControl):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in mercurial: {e}")
    name = "hg"
    dirname = ".hg"
    repo_name = "clone"
    schemes = (
