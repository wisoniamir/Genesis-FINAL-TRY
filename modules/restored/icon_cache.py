    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in icon_cache: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("icon_cache", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in icon_cache: {e}")
...
class IconCache(object):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in icon_cache: {e}")
