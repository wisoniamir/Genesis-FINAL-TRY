    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in utils: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("utils", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in utils: {e}")
...
class PlotlyJSONEncoder(_json.JSONEncoder):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in utils: {e}")
    """
    ...
    def default(self, obj):
        ...
        """
        # IMPLEMENTED: The ordering if these methods is *very* important. Is this OK?
        encoding_methods = (
