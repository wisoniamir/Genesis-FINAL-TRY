    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in sas_xport: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("sas_xport", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in sas_xport: {e}")
...
class XportReader(ReaderBase, abc.Iterator):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in sas_xport: {e}")
