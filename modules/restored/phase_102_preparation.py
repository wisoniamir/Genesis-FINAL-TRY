...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("phase_102_preparation", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("phase_102_preparation", "position_calculated", {
        ...
        try:
            ...
            for module_path, module_data in registry.get('modules', {}).items():
                ...
                if any(keyword in module_name for keyword in [
                    ...
                    if not module_data.get('live_data_usage', False):
                        readiness_score += 1
