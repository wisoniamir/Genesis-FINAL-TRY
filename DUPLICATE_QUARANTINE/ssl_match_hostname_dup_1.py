    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in ssl_match_hostname: {e}")
                    return False
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("ssl_match_hostname", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in ssl_match_hostname: {e}")
...
class CertificateError(ValueError):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in ssl_match_hostname: {e}")
    pass
