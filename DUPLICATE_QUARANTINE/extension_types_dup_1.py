    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in extension_types: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("extension_types", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in extension_types: {e}")
...
class ArrowPeriodType(pyarrow.ExtensionType):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in extension_types: {e}")
