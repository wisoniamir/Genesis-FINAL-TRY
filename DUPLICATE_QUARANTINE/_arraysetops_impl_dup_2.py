    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in _arraysetops_impl: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("_arraysetops_impl", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in _arraysetops_impl: {e}")
...
class UniqueAllResult(NamedTuple):
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in _arraysetops_impl: {e}")
    values: np.ndarray
    indices: np.ndarray
