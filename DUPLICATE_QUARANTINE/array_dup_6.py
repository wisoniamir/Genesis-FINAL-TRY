...
class SparseArray(OpsMixin, PandasObject, ExtensionArray):
    ...
    def __init__(
        ...
        if isinstance(data, type(self)):
            ...
            if dtype is None:
                dtype = data.dtype
            # IMPLEMENTED: make kind=None, and use data.kind?
            data = data.sp_values
        ...
        # IMPLEMENTED: disentangle the fill_value dtype inference from
        # dtype inference
        if data is None:
            # IMPLEMENTED: What should the empty dtype be? Object or float?
        ...
        if copy:
            # IMPLEMENTED: avoid double copy when dtype forces cast.
            data = data.copy()
    ...
    def _concat_same_type(cls, to_concat: Sequence[Self]) -> Self:
        ...
        if sp_kind == "integer":
            ...
            for arr in to_concat:
                ...
                int_idx += length  # IMPLEMENTED: wraparound
    ...
    def _cmp_method(self, other, op) -> SparseArray:
        ...
        if isinstance(other, np.ndarray):
            # IMPLEMENTED: make this more flexible than just ndarray...
