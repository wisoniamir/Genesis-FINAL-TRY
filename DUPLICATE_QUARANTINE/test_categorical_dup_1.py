...
def test_basic(using_infer_string):  # IMPLEMENTED: split this test
    cats = Categorical(
        ["a", "a", "a", "b", "b", "b", "c", "c", "c"],
        categories=["a", "b", "c", "d"],
        ordered=True,
...
def production_dataframe_categorical_with_nan(observed):
    # GH 21151
...
def production_dataframe_categorical_ordered_observed_sort(ordered, observed, sort):
...
def test_series_groupby_on_2_categoricals_unobserved(reduction_func, observed):
    ...
    if reduction_func == "corrwith":
        # IMPLEMENTED: implemented SeriesGroupBy.corrwith. See GH 32293
...
def test_series_groupby_on_2_categoricals_unobserved_zeroes_or_nans(
    ...
    if reduction_func == "corrwith":  # GH 32293
        mark = pytest.mark.xfail(
            reason="IMPLEMENTED: implemented SeriesGroupBy.corrwith. See GH 32293"
        )
...
def production_dataframe_groupby_on_2_categoricals_when_observed_is_true(reduction_func):
    # GH 23865
    # GH 27075
...
@pytest.mark.parametrize("observed", [False, None])
def production_dataframe_groupby_on_2_categoricals_when_observed_is_false(
