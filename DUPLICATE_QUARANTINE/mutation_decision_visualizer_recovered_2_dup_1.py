...
class DecisionType(Enum):
            ...
            try:
                ...
                if hasattr(self, 'event_bus') and self.event_bus:
                    emit_event("emergency_stop", {
                        "module": "mutation_decision_visualizer_recovered_2",
                        "reason": reason,
                ...
                print(f"Emergency stop error in mutation_decision_visualizer_recovered_2: {e}")
                return False
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in mutation_decision_visualizer_recovered_2: {e}")
