...
class ReorderglyphsEventBusIntegration:
    ...
    """EventBus integration for reorderGlyphs"""
    
    def __init__(self):
        self.module_id = "reorderGlyphs"
        self.event_routes = []
...
reorderGlyphs_eventbus = ReorderglyphsEventBusIntegration()
