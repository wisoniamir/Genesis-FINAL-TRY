    ...
    class TelemetryManager:
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                telemetry_data = {
                    ...
                    "module": "mt5_order_executor_recovered_1",
                    "event": event,
                    "data": data or {}
                }
                try:
                    emit_telemetry("mt5_order_executor_recovered_1", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in mt5_order_executor_recovered_1: {e}")
...
class FTMOComplianceEngine:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in mt5_order_executor_recovered_1: {e}")
