...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("activate_phase_91c_lockdown", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("activate_phase_91c_lockdown", "position_calculated", {
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("activate_phase_91c_lockdown", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in activate_phase_91c_lockdown: {e}")
...
class Phase91CLockdownEngine:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in activate_phase_91c_lockdown: {e}")
