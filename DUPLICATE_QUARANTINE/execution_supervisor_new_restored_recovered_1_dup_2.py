...
Type: RECOVERED
Restored: 2025-06-19T12:08:20.666836+00:00
                ...
                try:
                    ...
                    if self.event_bus:
                        emit_event("module_initialized", {
                            "module": "execution_supervisor_new_restored_recovered_1",
                            "timestamp": datetime.now().isoformat(),
                            "status": "active"
                        })
                except Exception as e:
                    print(f"EventBus initialization error in execution_supervisor_new_restored_recovered_1: {e}")
        ORDER_TYPE_BUY = 0
        ORDER_TYPE_SELL = 1
        TRADE_ACTION_DEAL = 1
        ORDER_TIME_GTC = 0
