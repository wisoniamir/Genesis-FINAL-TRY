...
class PostTradeFeedbackCollectorEventBusIntegration:
    ...
    """EventBus integration for post_trade_feedback_collector"""
...
post_trade_feedback_collector_eventbus = PostTradeFeedbackCollectorEventBusIntegration()
