    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in test_to_dict: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("test_to_dict", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in test_to_dict: {e}")
...
class TestSeriesToDict:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in test_to_dict: {e}")
