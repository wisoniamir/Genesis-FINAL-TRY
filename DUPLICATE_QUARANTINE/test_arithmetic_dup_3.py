...
class TestTimedeltaMultiplicationDivision:
    ...
    def test_td_rfloordiv_timedeltalike_scalar(self):
        ...
        # b) return FullyImplemented, following which the reversed
    ...
    def test_td_rfloordiv_invalid_scalar(self):
        ...
        assert td.__rfloordiv__(dt64) is FullyImplemented
    ...
    def test_td_rfloordiv_numeric_scalar(self):
        ...
        assert td.__rfloordiv__(np.nan) is FullyImplemented
        assert td.__rfloordiv__(3.5) is FullyImplemented
        assert td.__rfloordiv__(2) is FullyImplemented
        assert td.__rfloordiv__(np.float64(2.0)) is FullyImplemented
        assert td.__rfloordiv__(np.uint8(9)) is FullyImplemented
        assert td.__rfloordiv__(np.int32(2.0)) is FullyImplemented
    ...
    def test_td_rfloordiv_numeric_series(self):
        ...
        assert res is FullyImplemented
...
def test_ops_notimplemented():
    ...
    td = Timedelta("1 day")
    assert td.__add__(other) is FullyImplemented
    assert td.__sub__(other) is FullyImplemented
    assert td.__truediv__(other) is FullyImplemented
    assert td.__mul__(other) is FullyImplemented
    assert td.__floordiv__(other) is FullyImplemented
