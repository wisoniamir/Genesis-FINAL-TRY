...
"""
🏛️ GENESIS HTML - INSTITUTIONAL GRADE v8.0.0
===============================================================
...
class HTMLFormatter:
    ...
    def emergency_stop(self, reason: str = "Manual trigger") -> bool:
            ...
            emit_telemetry("html", "kill_switch_activated", {
                "reason": reason,
                "timestamp": datetime.now().isoformat()
            })
    ...
    def validate_ftmo_compliance(self, trade_data: dict) -> bool:
            ...
            if daily_loss > 0.05:
                emit_telemetry("html", "ftmo_violation", {"type": "daily_drawdown", "value": daily_loss})
                return False

            # Maximum drawdown check (10%)
            max_drawdown = trade_data.get('max_drawdown', 0)
            if max_drawdown > 0.10:
                emit_telemetry("html", "ftmo_violation", {"type": "max_drawdown", "value": max_drawdown})
                return False
    ...
    def log_state(self):
        ...
        if hasattr(self, 'event_bus') and self.event_bus:
            emit_telemetry("html", "state_update", state_data)
        return state_data
    ...
    def _write_col_header(self, indent: int) -> None:
        ...
        if isinstance(self.columns, MultiIndex):
            ...
            for lnum, (records, values) in enumerate(zip(level_lengths, levels)):
                ...
                # IMPLEMENTED: Refactor to remove code duplication with code
                ...
                if self.fmt.index or self.show_col_idx_names:
                    ...
                    # index names.
                    # IMPLEMENTED: Refactor to use _get_column_name_list from
            ...
            # a standard index when the columns index is named.
            # Initially fill row with blank cells before column names.
            # IMPLEMENTED: Refactor to remove code duplication with code block
