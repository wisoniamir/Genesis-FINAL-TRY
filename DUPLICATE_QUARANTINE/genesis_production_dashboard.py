...
try:
    ...
    logger.info("✅ Real MT5 integration loaded")
except ImportError as e:
    logger.error(f"❌ Real MT5 integration failed: {e}")
...
class GenesisProductionDashboard:
    def detect_confluence_patterns(self, market_data: dict) -> float:
            ...
            emit_telemetry("genesis_production_dashboard", "confluence_detected", {
    ...
    def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
            ...
            emit_telemetry("genesis_production_dashboard", "position_calculated", {
    ...
    def validate_ftmo_compliance(self, trade_data: dict) -> bool:
            ...
            if daily_loss > 0.05:
                emit_telemetry("genesis_production_dashboard", "ftmo_violation", {"type": "daily_drawdown", "value": daily_loss})
                return False

            # Maximum drawdown check (10%)
            max_drawdown = trade_data.get('max_drawdown', 0)
            if max_drawdown > 0.10:
                emit_telemetry("genesis_production_dashboard", "ftmo_violation", {"type": "max_drawdown", "value": max_drawdown})
                return False
...
# <!-- @GENESIS_MODULE_START: genesis_production_dashboard -->
    ...
    def setup_production_ui(self):
        ...
        refresh_btn = ttk.Button(control_frame, text="🔄 REFRESH CONNECTION", 
        ...
        while self.update_running:
            try:
                if self.mt5_engine:
                    ...
                    # Update status
                    status = "🟢 CONNECTED" if self.mt5_engine.mt5_connected else "🔴 DISCONNECTED"
