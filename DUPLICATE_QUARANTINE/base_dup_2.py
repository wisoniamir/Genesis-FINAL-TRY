...
from pip._internal.utils.compat import stdlib_pkgs  # IMPLEMENTED: Move definition here.
...
class BaseDistribution(Protocol):
    ...
    def editable_project_location(self) -> Optional[str]:
        ...
        """
        # IMPLEMENTED: this property is relatively costly to compute, memoize it ?
        ...
        if direct_url:
            ...
            if egg_link_path:
                # IMPLEMENTED: get project location from second line of egg_link file
