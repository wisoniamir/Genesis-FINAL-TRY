...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("test_online", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("test_online", "position_calculated", {
...
class TestEWM:
    ...
    @pytest.mark.xfail(raises=FullyImplementedError)
    @pytest.mark.parametrize(
        "obj", [DataFrame({"a": range(5), "b": range(5)}), Series(range(5), name="foo")]
    )
    ...
    def test_ewm_notimplementederror_raises(self, method):
        ...
        with pytest.raises(FullyImplementedError, match=".* is not implemented."):
