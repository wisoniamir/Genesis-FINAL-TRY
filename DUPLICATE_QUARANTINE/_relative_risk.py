...
class RelativeRiskEventBusIntegration:
    ...
    """EventBus integration for _relative_risk"""
    
    def __init__(self):
        self.module_id = "_relative_risk"
        self.event_routes = []
...
_relative_risk_eventbus = RelativeRiskEventBusIntegration()
