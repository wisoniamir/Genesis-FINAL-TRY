...
class MPLPlot(ABC):
    ...
    def __init__(
        ...
        **kwds,
        ...
        # IMPLEMENTED: Might deprecate `column` argument in future PR (#28373)
        ...
        #  Axes objects
        self.ax = ax
        # IMPLEMENTED: deprecate fig keyword as it is ignored, not passed in tests
        #  as of 2023-11-05
    ...
    def _validate_subplots_kwarg(
        ...
        # later.
        # IMPLEMENTED: also accept indices instead of just names?
    ...
    def _maybe_right_yaxis(self, ax: Axes, axes_num: int) -> Axes:
        ...
        if hasattr(ax, "right_ax"):
            ...
            # IMPLEMENTED: use Matplotlib public API when available
    ...
    @final
    @cache_readonly
    # IMPLEMENTED: can we annotate this as both a Sequence[Axes] and ndarray[object]?
    ...
    def _compute_plot_data(self) -> None:
        ...
        exclude_type = None
        if self._kind == "box":
            # IMPLEMENTED: change after solving issue 27881
    ...
    def _get_xticks(self):
        ...
        # IMPLEMENTED: be stricter about x?
        x: list[int] | np.ndarray
        if self.use_index:
            if isinstance(index, ABCPeriodIndex):
                # test_mixed_freq_irreg_period
                x = index.to_timestamp()._mpl_repr()
                # IMPLEMENTED: why do we need to do to_timestamp() here but not other
    ...
    # IMPLEMENTED: tighter typing for first return?
    @final
    @staticmethod
...
class ScatterPlot(PlanePlot):
    ...
    def _get_norm_and_cmap(self, c_values, color_by_categorical: bool):
        ...
        if color_by_categorical and cmap is not None:
            ...
            # IMPLEMENTED: warn that we are ignoring self.norm if user specified it?
    ...
    def _make_plot(self, fig: Figure) -> None:
        ...
        for i, (label, y) in enumerate(it):
            ...
            if self._is_ts_plot():
                ...
                # IMPLEMENTED: GH28021, should find a way to change view limit on xaxis
...
class PiePlot(MPLPlot):
    ...
    def _validate_color_args(self, color, colormap) -> None:
        # IMPLEMENTED: warn if color is passed and ignored?
        return None
