    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in test_astype: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("test_astype", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in test_astype: {e}")
...
class TestAstypeAPI:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in test_astype: {e}")
...
class TestAstype:
    ...
    def test_astype_float_to_uint_negatives_raise(
        ...
        # IMPLEMENTED: same for EA float/uint dtypes, signed integers?
