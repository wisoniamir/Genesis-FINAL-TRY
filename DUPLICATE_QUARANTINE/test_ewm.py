...
# <!-- @GENESIS_MODULE_START: test_ewm -->
"""
🏛️ GENESIS TEST_EWM - INSTITUTIONAL GRADE v8.0.0
===============================================================
...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("test_ewm", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("test_ewm", "position_calculated", {
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in test_ewm: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("test_ewm", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in test_ewm: {e}")
...
def test_ewma_times_adjust_false_raises():
    # GH 40098
    with pytest.raises(
        FullyImplementedError, match="times is not supported with adjust=False."
    ):
        Series(range(1)).ewm(
...
def test_ewm_sum_adjust_false_notimplemented():
    ...
    with pytest.raises(FullyImplementedError, match="sum is not"):
        data.sum()
