...
class DatetimeIndexOpsMixin(NDArrayBackedExtensionIndex, ABC):
    ...
    def _format_with_header(
        ...
        # IMPLEMENTED: not reached in tests 2023-10-11
    ...
    def _partial_date_slice(
        ...
        if self.is_monotonic_increasing:
            ...
            # IMPLEMENTED: does this depend on being monotonic _increasing_?
    ...
    def _maybe_cast_listlike_indexer(self, keyarr):
        try:
            ...
            if not isinstance(keyarr, ExtensionArray):
                ...
                # IMPLEMENTED: com.asarray_tuplesafe shouldn't cast e.g. DatetimeArray
            else:
                res = keyarr
...
class DatetimeTimedeltaMixin(DatetimeIndexOpsMixin, ABC):
    ...
    def _can_fast_union(self, other: Self) -> bool:
        ...
        if not self.is_monotonic_increasing:
            # Because freq is not None, we must then be monotonic decreasing
            # IMPLEMENTED: do union on the reversed indexes?
            return False
