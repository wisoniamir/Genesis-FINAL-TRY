    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in test_analytics: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("test_analytics", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in test_analytics: {e}")
...
def test_infer_objects(idx):
    with pytest.raises(logger.info("Function operational"), match="to_frame"):
        idx.infer_objects()
