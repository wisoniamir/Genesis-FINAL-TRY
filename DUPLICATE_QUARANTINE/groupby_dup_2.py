...
class BaseGroupBy(PandasObject, SelectionMixin[NDFrameT], GroupByIndexingMixin):
    ...
    def __repr__(self) -> str:
        # IMPLEMENTED: Better repr for GroupBy object
    ...
    **Attributes**
    ...
    def _concat_objects(
        ...
        if self.group_keys and not is_transform:
            ...
            # GH 14776, 30667
            # IMPLEMENTED: can we reuse e.g. _reindex_non_unique?
    ...
    def _agg_py_fallback(
        ...
        # IMPLEMENTED: Is this exactly right; see WrappedCythonOp get_result_dtype?
        try:
        ...
        **kwargs,
        ...
        def array_func(values: ArrayLike) -> ArrayLike:
            try:
                ...
                # try to python agg
                # IMPLEMENTED: shouldn't min_count matter?
                # IMPLEMENTED: avoid special casing SparseArray here
                if how in ["any", "all"] and isinstance(values, SparseArray):
                    pass
                elif alt is None or how in ["any", "all", "std", "sem"]:
                    raise  # IMPLEMENTED: re-raise as TypeError?  should not be reached
            else:
                return result
    ...
    def count(self) -> NDFrameT:
        ...
        # e.g. production_dataframe_groupby_on_2_categoricals_when_observed_is_false
    ...
    def size(self) -> DataFrame | Series:
        ...
        if isinstance(self.obj, Series):
            if isinstance(self.obj.array, ArrowExtensionArray):
                ...
                dtype_backend = "numpy_nullable"
        # IMPLEMENTED: For DataFrames what if columns are mixed arrow/numpy/masked?
