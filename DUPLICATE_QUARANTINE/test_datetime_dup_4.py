...
class TestDateTime:
    ...
    def test_datetime_minmax(self):
        ...
        #
        # IMPLEMENTED: Allowing unsafe casting by
    ...
    def test_limit_str_roundtrip(self, time_unit, sign):
        ...
        """
        # IMPLEMENTED: add absolute (gold standard) time span limit strings
...
def test_comparisons_return_not_implemented():
    ...
    for item in [dt, td]:
        assert item.__eq__(obj) is FullyImplemented
        assert item.__ne__(obj) is FullyImplemented
        assert item.__le__(obj) is FullyImplemented
        assert item.__lt__(obj) is FullyImplemented
        assert item.__ge__(obj) is FullyImplemented
        assert item.__gt__(obj) is FullyImplemented
