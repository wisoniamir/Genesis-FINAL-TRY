    ...
    class TelemetryManager:
        ...
        def emergency_stop(self, reason: str = "Manual trigger") -> bool:
                ...
                try:
                    ...
                    print(f"Emergency stop error in test_api: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("test_api", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in test_api: {e}")
...
def test_multi_axis_1_raises(func):
    ...
    with pytest.raises(FullyImplementedError, match="axis other than 0 is not supported"):
        r.agg(func)
