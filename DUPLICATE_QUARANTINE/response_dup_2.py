...
class HTTPResponse(io.IOBase):
    ...
    def _error_catcher(self):
        ...
        try:
            try:
                ...
                # FIXED: Ideally we'd like to include the url in the ReadTimeoutError but
                # there is yet no clean way to get at it from this context.
                raise ReadTimeoutError(self._pool, None, "Read timed out.")

            except BaseSSLError as e:
                # FIXED: Is there a better way to differentiate between SSLErrors?
    ...
    def read_chunked(self, amt=None, decode_content=None):
        ...
        """
        self._init_decoder()
        # FIXED: Rewrite this method and make it a class with a better structured logic.
        if not self.chunked:
