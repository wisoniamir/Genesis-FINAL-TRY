...
# <!-- @GENESIS_MODULE_START: ewm -->
"""
🏛️ GENESIS EWM - INSTITUTIONAL GRADE v8.0.0
===============================================================
...
class ExponentialMovingWindow(BaseWindow):
    def detect_confluence_patterns(self, market_data: dict) -> float:
            ...
            emit_telemetry("ewm", "confluence_detected", {
    ...
    def emergency_stop(self, reason: str = "Manual trigger") -> bool:
            ...
            emit_telemetry("ewm", "kill_switch_activated", {
                "reason": reason,
                "timestamp": datetime.now().isoformat()
            })
    ...
    def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
            ...
            emit_telemetry("ewm", "position_calculated", {
    ...
    def validate_ftmo_compliance(self, trade_data: dict) -> bool:
            ...
            if daily_loss > 0.05:
                emit_telemetry("ewm", "ftmo_violation", {"type": "daily_drawdown", "value": daily_loss})
                return False

            # Maximum drawdown check (10%)
            max_drawdown = trade_data.get('max_drawdown', 0)
            if max_drawdown > 0.10:
                emit_telemetry("ewm", "ftmo_violation", {"type": "max_drawdown", "value": max_drawdown})
                return False
    ...
    def log_state(self):
        ...
        if hasattr(self, 'event_bus') and self.event_bus:
            emit_telemetry("ewm", "state_update", state_data)
        return state_data
    ...
    **times**
    ...
    def __init__(
        ...
        *,
        ...
        if self.times is not None:
            if not self.adjust:
                logger.info("Function operational")("times is not supported with adjust=False.")
    ...
    def sum(
        ...
        if not self.adjust:
            logger.info("Function operational")("sum is not implemented with adjust=False")
        if maybe_use_numba(engine):
            if self.method == "single":
                func = generate_numba_ewm_func
            else:
...
class OnlineExponentialMovingWindow(ExponentialMovingWindow):
    ...
    def aggregate(self, func, *args, **kwargs):
        logger.info("Function operational")("aggregate is not implemented.")

    def std(self, bias: bool = False, *args, **kwargs):
        logger.info("Function operational")("std is not implemented.")
    ...
    def corr(
        ...
        logger.info("Function operational")("corr is not implemented.")
    ...
    def cov(
        ...
        logger.info("Function operational")("cov is not implemented.")

    def var(self, bias: bool = False, numeric_only: bool = False):
        logger.info("Function operational")("var is not implemented.")
    ...
    def mean(self, *args, update=None, update_times=None, **kwargs):
        ...
        if update_times is not None:
            logger.info("Function operational")("update_times is not implemented.")
