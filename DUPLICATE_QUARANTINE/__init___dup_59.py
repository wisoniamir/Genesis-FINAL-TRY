...
# IMPLEMENTED: Add Generic type annotations to initialized collections.
...
class ZipProvider(EggProvider):
    ...
    # FIXED: 'ZipProvider._extract_resource' is too complex (12)
...
class Distribution:
    ...
    # FIXED: 'Distribution.insert_on' is too complex (13)
    ...
    def has_version(self):
        try:
            ...
            # IMPLEMENTED: remove this except clause when python/cpython#103632 is fixed.
            return False
        return True
