    ...
    class TelemetryManager:
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                telemetry_data = {
                    ...
                    "module": "ml_execution_signal_loop_recovered_2",
                    "event": event,
                    "data": data or {}
                }
                try:
                    emit_telemetry("ml_execution_signal_loop_recovered_2", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in ml_execution_signal_loop_recovered_2: {e}")
...
class MLSignalDecision:
    ...
    def initialize_eventbus(self):
            ...
            try:
                ...
                print(f"EventBus initialization error in ml_execution_signal_loop_recovered_2: {e}")
