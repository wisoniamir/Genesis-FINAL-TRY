...
try:
    ...
    class TelemetryManager:
        def detect_confluence_patterns(self, market_data: dict) -> float:
                ...
                emit_telemetry("test_architect_compliant_broker_discovery_recovered_2", "confluence_detected", {
        ...
        def calculate_position_size(self, risk_amount: float, stop_loss_pips: float) -> float:
                ...
                emit_telemetry("test_architect_compliant_broker_discovery_recovered_2", "position_calculated", {
                ...
                try:
                    ...
                    if hasattr(self, 'event_bus') and self.event_bus:
                        emit_event("emergency_stop", {
                            "module": "test_architect_compliant_broker_discovery_recovered_2",
                            "reason": reason,
                            "timestamp": datetime.now().isoformat()
                        })
                    ...
                    print(f"Emergency stop error in test_architect_compliant_broker_discovery_recovered_2: {e}")
                    return False
        ...
        def emit_module_telemetry(self, event: str, data: dict = None):
                ...
                try:
                    emit_telemetry("test_architect_compliant_broker_discovery_recovered_2", event, telemetry_data)
                except Exception as e:
                    print(f"Telemetry error in test_architect_compliant_broker_discovery_recovered_2: {e}")
...
✅ Replace ALL mock/simulation logic with real MT5 adapter calls
✅ Test real account profile detection via MT5 connection
✅ Validate telemetry emission for rule_profile_active, account_type_detected, override_mode_enabled  
✅ EventBus-only communication (no direct calls)
✅ Full architect mode compliance validation

COMPLIANCE REQUIREMENTS:
🔐 Real MT5 account information only
🔐 EventBus routing mandatory
🔐 Telemetry integration required
🔐 No mock, patch, or simulation logic
🔐 System tree registration verification
...
class ArchitectCompliantBrokerDiscoveryTest:
    ...
    - ✅ Live account profile detection
    - ✅ Rule override mode validation 
    - ✅ Telemetry emission verification
    - ✅ EventBus compliance testing
    - ✅ System integrity validation
    
    ZERO TOLERANCE POLICY:
    - ❌ No mocks, patches, or simulation logic
    - ❌ No fallback data or dummy responses
    ...
    def __init__(self):
        ...
        try:
            ...
            if not mt5.initialize():
                self.logger.error("❌ ARCHITECT VIOLATION: Real MT5 connection required")
                raise RuntimeError("Architect mode requires active MT5 connection")
            else:
                self.logger.info("✅ Real MT5 connection verified")
                mt5.shutdown()  # Clean close for test setup
        except ImportError:
            self.logger.error("❌ ARCHITECT VIOLATION: MetaTrader5 module required")
        ...
        try:
            ...
            self.logger.info("✅ Broker Discovery Engine MT5 integration verified")
        except Exception as e:
            self.logger.error(f"❌ ARCHITECT VIOLATION: Broker Discovery Engine MT5 integration failed - {e}")
            raise
    ...
    def setup_test_environment(self):
        ...
        try:
            ...
            self.logger.info(f"✅ Real MT5 account connected - Broker: {account_info.company}")
            mt5.shutdown()
    ...
    def on_broker_rules_discovered(self, event_data: Dict[str, Any]):
        ...
        self.logger.info(f"✅ Real broker rules event received: {event_data.get('rule_profile', 'unknown')}")
    ...
    def on_trading_rules_update(self, event_data: Dict[str, Any]):
        ...
        self.logger.info(f"✅ Real trading rules update received")
    ...
    def on_account_type_detected(self, event_data: Dict[str, Any]):
        ...
        self.logger.info(f"✅ Real account type detected: {event_data.get('account_type', 'unknown')}")
    ...
    def on_broker_discovery_telemetry(self, event_data: Dict[str, Any]):
        ...
        self.logger.info("✅ Real broker discovery telemetry received")
    ...
    def run_all_tests(self):
        ...
        self.logger.info("🚀 STARTING ARCHITECT MODE COMPLIANT BROKER DISCOVERY TESTS")
        ...
        try:
            ...
            if self.test_results["mock_usage_detected"]:
                self.logger.error("❌ ARCHITECT VIOLATION: Mock usage detected")
